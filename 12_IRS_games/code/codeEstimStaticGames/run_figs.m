...
plt_range = 5; % range for plotting likelihood functions
...
for esr = 1:numel(pa); % Loop over equilibria
  ...
  alphavec = linspace(alpha - plt_range, alpha + plt_range,100);
  betavec = linspace(beta - plt_range, beta + plt_range, 100);
