...
Mcmc$betabar[sum(!Mcmc$fixedcoef),1] = log(0.4)
Mcmc$betaA[sum(!Mcmc$fixedcoef),sum(!Mcmc$fixedcoef)] = 1

Mcmc$S0[sum(!Mcmc$fixedcoef),sum(!Mcmc$fixedcoef)] = Mcmc$S0[sum(!Mcmc$fixedcoef),sum(!Mcmc$fixedcoef)]/10
